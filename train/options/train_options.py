...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--local_rank', type=int, default=int(os.environ["LOCAL_RANK"]))
        ...
        self.parser.add_argument('--load_pretrain', type=bool, default=False, help='load the pretrained model from the specified location')
        ...
        self.parser.add_argument('--PBTN_checkpoint', type=str, help='load the pretrained model from the specified location')
        self.parser.add_argument('--PFSN_checkpoint', type=str, help='load the pretrained model from the specified location')
