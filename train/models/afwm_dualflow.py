...
class AFWM(nn.Module):
    ...
    def __init__(self, opt, input_nc):
        ...
        self.aflow_net_bg = AFlowNet(len(num_filters))
        self.old_lr = opt.lr
    ...
    def forward(self, cond_input, image_input, image_edge):
        ...
        x_warp_bg, last_flow_bg, last_flow_all_bg, flow_all_bg, delta_list_bg, x_all, x_edge_all, delta_x_all, delta_y_all = self.aflow_net_bg(image_input, image_edge, image_pyramids, cond_pyramids)
